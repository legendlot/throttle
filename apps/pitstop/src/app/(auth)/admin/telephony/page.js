 ...
 *
 * It deliberately lists EVERY active user, not just the configured ones. The useful
 * question on this page is "who cannot make calls", and a list of only the working
 * rows hides precisely that.
 */
    ...
    <div style={{ maxWidth: 1000, margin: '0 auto' }}>
      <header style={{ marginBottom: 18 }}>
        ...
        <p style={{ margin: '5px 0 0', color: 'var(--t3)', fontSize: 13 }}>
          {configured} of {users.length} people can place calls from Pitstop.
