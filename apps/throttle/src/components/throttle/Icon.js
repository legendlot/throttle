'use client';
/* Lucide-style inline SVG set — stroke-based, 1.75px, currentColor.
   Ported verbatim from the redesign prototype icons.jsx. */
import React from 'react';

const P = {
  search:   (<><circle cx="11" cy="11" r="7"/><path d="m21 21-4.3-4.3"/></>),
  command:  (<path d="M15 6a3 3 0 1 0 3 3h-3V6Zm-6 0a3 3 0 1 1-3 3h3V6Zm0 12a3 3 0 1 1-3-3h3v3Zm6 0a3 3 0 1 0 3-3h-3v3Z" />),
  ...
  bell:     (<><path d="M10.27 21a2 2 0 0 0 3.46 0"/><path d="M3.26 15.33A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.67C19.41 13.94 19 12.81 19 9a7 7 0 1 0-14 0c0 3.81-.39 4.94-1.74 6.33"/></>),
...
export function Icon({ name, size = 18, sw = 1.75, style, ...rest }) {
  return (
...
export function Sparkline({ data, color = 'var(--yellow)', w = 64, h = 22, fill = false }) {
