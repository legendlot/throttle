...
export function RedlineTopbar({ refreshing = false, lastRefreshed = null, right }) {
  ...
  return (
    <header className="rl-topbar" style={{ height: 56, borderBottom: '1px solid var(--border)', display: 'flex',
      ...
      <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 16 }}>
        {right}
        {updated && <span className="num rl-updated" style={{ fontSize: 11, color: 'var(--t3)', whiteSpace: 'nowrap' }}>
