...
// Picklist category/type ordering — MUST STAY IDENTICAL to redline
// components/production-runs/RunDetailPanel.js. These two copies drifted from the data together
// and were re-derived together on 2026-09-10; if you edit one, edit the other in the same commit.
//
...
export default function IssueQueuePage() {
  ...
  // FBU run-model refinement (S180): the store-side FBU flip (setRunIssueMode) is REMOVED.
  // Production now declares the format (CKD/SKD/FBU) at run-create; the store projects it 1:1
  // and may only Issue or Reject — no flip. (RULE-FBU-001 rewritten; reverses S121.)
