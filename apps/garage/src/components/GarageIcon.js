 ...
 */
export function GarageIcon({ size = 20, showDot = false, strokeWidth = 2 }) {
  const w = size;
  ...
  return (
    ...
    >
      <rect x="2" y="2" width="36" height="26" rx="2" stroke="#F2CD1A" strokeWidth={strokeWidth} />
      <line x1="2" y1="10" x2="38" y2="10" stroke="#F2CD1A" strokeWidth="1.5" opacity="0.5" />
      <line x1="2" y1="17" x2="38" y2="17" stroke="#F2CD1A" strokeWidth="1.5" opacity="0.5" />
      <line x1="2" y1="23" x2="38" y2="23" stroke="#F2CD1A" strokeWidth="1.5" opacity="0.5" />
      {showDot && <circle cx="20" cy="28" r="1.5" fill="#F2CD1A" opacity="0.5" />}
    </svg>
  );
}
