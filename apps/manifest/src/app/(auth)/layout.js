  ...
  return (
    <div style={{ display: 'flex', height: '100dvh', overflow: 'hidden' }}>
      <Sidebar
        ...
        appLabel="MANIFEST"
        appShortLabel="MF"
        appIcon={<img src="/favicon.svg" alt="Manifest" style={{ height: 20, width: 'auto', display: 'block' }} />}
      />
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        <Topbar navGroups={navGroups} pathname={pathname} onTabSelect={(item) => router.push(item.route)} />
