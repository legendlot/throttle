...
const PO_CATEGORIES = [
  ...
  { key: 'stickers',      Icon: Tag,         title: 'Stickers',       sub: 'India',              desc: 'Product stickers, decals',                    order_type: 'Para',       source: 'India', currency: 'INR', incoterms: 'Local delivery', bom_filter: { type: 'part_category', value: ['Sticker', 'UPC Sticker'] /* S372: LOT-UPC codes got their own category */ } },
