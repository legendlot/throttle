import {
  ...
  Inbox, Wallet, Shield, Users, Boxes, Settings, Store, ClipboardList, HandCoins, ReceiptText, Layers, Scale,
} from 'lucide-react';
...
export const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      // Signed per-partner balance — Collections lists only invoices with money owed, so a
      // partner sum of it overstates what that partner owes (Tally recon, 2026-09-11).
      { id: 'sales-party-balances', label: 'Party Balances', route: '/sales/party-balances', icon: Scale, requires: 'sales_view' },
