...
function buildCommands() {
  ...
  cmds.unshift(
    ...
    { k: 'New repack run', grp: 'Action', icon: 'swap', route: '/repack-runs/new', s: 'Create' },
    { k: 'Unit restock', grp: 'Action', icon: 'undo', route: '/restock', s: 'Open' },
    { k: 'Dispatch counts', grp: 'Action', icon: 'clipboard', route: '/dispatch-counts', s: 'Open' },
  );
  return cmds;
}
