...
import { PodiumIcon } from '../../components/PodiumIcon.js';
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: 360, padding: '0 20px' }}>
        <img src="/lot-logo.png" alt="Legend of Toys" style={{ height: 56, width: 'auto', marginBottom: 36 }} />
        ...
        <button
          ...
          style={{
            width: '100%', background: 'var(--podium-accent)', color: '#1f1f1f', border: 'none',
